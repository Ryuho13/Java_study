...
//	좌석 정렬 후: [A1, A2, A3, B1, B2]
	...
	public static void main(String[] args) {
		...
		sit.add("B1");
		sit.add("B2");
		System.out.println("초기 좌석 목록: " + sit);
		sit.add(2,"A3");
		System.out.println("A3 좌석 추가 후: " + sit);
		
		System.out.println("예약하고 싶은 좌석을 입력하여 주세요.");
		
		String sitSet = sc.nextLine();
		if (sit.contains(sitSet)) {
			int reservationSit = sit.indexOf( sitSet);
			sit.set(reservationSit, sitSet+ "(예약)");
			System.out.println("예약좌석: " + sitSet);
		}else {
			System.out.println(sitSet + "은(는) 존재하지 않는 좌석입니다.");
		}
		System.out.println("좌석 예약표" + sit);

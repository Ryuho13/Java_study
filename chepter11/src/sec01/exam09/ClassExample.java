...
public class ClassExample {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		//(메타 데이터 : "데이터에 대한 데이터" , 즉 어떤데이터를 설명하는 정보)
		// JVM내에서 한 클래스당 하나의 Class rorcpaks whswo
		...
		// 이외에도 필드/ 생성자 / 메소드 정보도 얻을수 있는데
		// 이정보를 얻어 활용하는것을 자바에서는 " 리플렉션" 이라고 부름

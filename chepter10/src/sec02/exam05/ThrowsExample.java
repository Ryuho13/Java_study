...
public class ThrowsExample {
	...
	public static void main(String[] args) throws ClassNotFoundException{
		...
		//다양한 예외 출력 방법
		    ...
		    e.printStackTrace(); // 호출 스택을 추적하여 콘솔에 출력(개발 기에만 디버깅 용도로 사용)
		}		
	}

	// 직접 처리하지 않고 "호출한 쪽에서 다양한 방식으로 처리할 수있도록" 예외 떠넘기기
	// 이렇게 하면 호출한 쪽에서 더 적절한 방식으로 대응할 수 있음(예: 로그 남기기, 사용자에게 알림 , 재시도 등)
	public static void findClasss() throws ClassNotFoundException {
		Class clazz = Class.forName("jana.lang.String2");
	}
}
